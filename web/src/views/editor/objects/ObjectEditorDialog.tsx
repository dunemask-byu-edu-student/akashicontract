...
export default function ObjectEditorDialog(props: ObjectEditorDialogProps) {
  if (!props.object) return;
  function addChanges() {}
  return (
    <Dialog.Root open={!!props.object} onOpenChange={props.close} size="md" placement="center">
      <Portal>
        <Dialog.Backdrop />
        <Dialog.Positioner>
